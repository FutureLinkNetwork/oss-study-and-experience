...
class UserController extends Controller
{
    ...
    {
        $currentUser = User::with(['role', 'subdomain'])->find(Auth::id());
        $subdomainId = app(SubdomainService::class)->currentSubdomainId($request);
        ...
        $request->validate([
            ...
            'login_id' => [
                ...
                'max:255',
                'regex:/^[a-zA-Z0-9_]+$/',
                Rule::unique('users')->where(function ($query) use ($subdomainId) {
        ...
        $userData['subdomain_id'] = $subdomainId;
    ...
    public function edit(Request $request, User $user)
    {
        ...
        app(SubdomainService::class)->ensureBelongsToCurrentSubdomain($request, $user);
