...
class InquiryController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('user.inquiries.index', compact('subdomain', 'inquiries'));
    }
    ...
    public function create(Request $request): View
    {
        ...
        return view('user.inquiries.create', compact('subdomain'));
    }
    ...
    public function store(StoreInquiryRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('user.inquiries.index')
    ...
    public function show(Request $request, Inquiry $inquiry): View|RedirectResponse
    {
        ...
        return view('user.inquiries.show', compact('subdomain', 'inquiry'));
    }
}
