...
@section('title', 'お問い合わせ管理 - 習い事クーポン管理システム')
                ...
                <div class="p-6">
                    <form method="GET" action="{{ route('admin.contacts.index') }}" class="space-y-4">
                        ...
                        <div class="flex justify-end space-x-4 mt-4">
                            <a href="{{ route('admin.contacts.index') }}" class="btn-base btn-back btn-m">
                    ...
                    <div class="">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">お問い合わせ日時</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">名前</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" style="width:130px">ステータス</th>
                                ...
                                @forelse($contacts as $contact)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($contact->is_confirmed == 2)
                                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">
                                                    処理済み
                                                </span>
                                            @elseif($contact->is_confirmed == 1)
