...
@section('title', '初回パスワード変更 - ' . $subdomain->system_name)
...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="bg-white rounded-lg shadow-md p-8">
        ...
        <div>
            <div class="mx-auto h-16 w-16 flex items-center justify-center bg-yellow-100 rounded-full">
            ...
            <div class="mt-2 text-center">
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                    <i class="fas fa-exclamation-triangle mr-1"></i>初回ログインのためパスワード変更が必要です
                </span>
            </div>
        </div>
        
        <form class="mt-8 space-y-6" method="POST" action="{{ route('user.password.change') }}" id="password-change-form">
            @csrf
