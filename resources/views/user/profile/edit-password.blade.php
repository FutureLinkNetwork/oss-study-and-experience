...
@section('title', 'パスワード変更 - '.$subdomain->system_name)
        ...
        <div class="px-4 sm:px-0">
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <form method="POST" action="{{ route('user.profile.update.password') }}" id="password-update-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mt-6 flex justify-end space-x-4">
                            ...
                            <button type="submit" id="password-submit-button"
                                    class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-md text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-gray-400 disabled:cursor-not-allowed">
