    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="mt-4 text-sm">
            <ol class="flex flex-wrap gap-2 text-gray-500">
                ...
                <li><span>/</span></li>
                <li><a href="{{ route('user.inquiries.index') }}" class="hover:text-gray-700">問い合わせ</a></li>
                <li><span>/</span></li>
        ...
        <div class="max-w-3xl mx-auto px-4 mt-4 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <form method="POST" action="{{ route('user.inquiries.store') }}" class="space-y-4">
                        @csrf
