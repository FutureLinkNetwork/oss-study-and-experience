...
@section('title', 'メールアドレス変更 - 習い事クーポン管理システム')
        ...
        <div class="px-4 sm:px-0">
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <form method="POST" action="{{ route('business.profile.update.email') }}" id="email-update-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mt-6 flex justify-end space-x-4">
                            ...
                            <button type="submit"
                                    class="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-md text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
