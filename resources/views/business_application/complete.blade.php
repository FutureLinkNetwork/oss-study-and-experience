    ...
    <div class="max-w-2xl mx-auto text-center">
        ...
        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8">
            <div class="text-yellow-800">
                ...
                <div class="text-left text-sm space-y-1">
                    ...
                    <p>• メールアドレスの変更があった場合は、速やかにご連絡ください</p>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-4">
            <a href="{{ route('welcome') }}" class="btn-base btn-back btn-l w-full sm:w-auto">
                ...
                <a href="{{ route('contact') }}" target="_blank" class="btn-base btn-cancel btn-l w-full sm:w-auto"><i class="fas fa-envelope mr-2"></i>お問い合わせ</a>
        </div>
    </div>
</div>
<script>
(function() {
    ...
    var prefix = 'business_application_draft';
    deleteCookie(prefix);
    for (var i = 1; i < 20; i++) {
